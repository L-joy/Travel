		...
		<view class="addTag">
			<view class="tag">
				<view class="tag-content">
					...
					<view class="mid">
						<view class="mid-top">
							<view class="tagHome" @click="chooseTag" :data-name="tagHome">家</view>
							<view class="tagSchool" @click="chooseTag" :data-name="tagSchool">学校</view>
							<view class="tagCompany" @click="chooseTag" :data-name="tagCompany">公司</view>
						</view>
