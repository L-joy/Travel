<template>
	<view>
		<view class="orderList">
			...
			<view class="date" v-show="showDate1">
				<view class="order-date" @tap="showCaledar = !showCaledar">
					<view class="order-date-top">
						<text class="fontStyle12"><text class="date-title">入住</text><text class="date-sum">共 {{dateSum}} 晚</text><text
							 class="date-title">离店</text></text>
					</view>
			...
			<!-- 特产 -->
			<view class="message5" v-show="showMessage5">
				<view class="message5-content">
					<view class="message5-box">
						<view class="message5-top" @click="goAddress">
		    		...
		    		<view class="Popcontent">
		    			<view class="Pop-content-top">
		    				...
		    				<view class="Pop-top-right">
								 <cmd-icon type="close" size="12" color="#333333" @click="cancel('one')"></cmd-icon>
		    				</view>
		    			</view>
		    ...
		    <uni-popup ref="two" :type="type" :custom="true" @change="change">
		    	<view class="Popup">
		    		<view class="Popcontent">
		    			<view class="Pop-content-top">
		    				<view class="Pop-top-left">
		    					<text class="fontStyle12">预计到达</text>
		    				</view>
		    				<view class="Pop-top-right">
								<cmd-icon type="close" size="12" color="#333333" @click="cancel('two')"></cmd-icon>
		    				</view>
		    			</view>
